...
const envSchema = z.object({
  // LLM Provider
  LLM_PROVIDER: z.enum(['openai', 'openrouter', 'ollama','openrouter-fetch']).default('ollama'),
  ...
  LLM_MODEL: z.string().default('gpt-4o:20b'),
  ...
  DEFAULT_MAX_TOKENS: z.string().default('10000'),
