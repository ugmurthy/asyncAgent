    ...
    try {
      ...
      conversation = [
        ...conversation,
        {
          ...
          content: prompt,
          image:
            conversation.length === 0 ? (imagePreview ?? undefined) : undefined,
        },
        {
          role: "assistant",
...
<div class="max-w-2xl mx-auto pb-24">
    ...
    {#if conversation.length > 0}
      <div class="flex gap-2">
        <div class="relative group">
          ...
          <div
            class="hidden group-hover:block absolute right-0 mt-1 w-40 bg-white border border-gray-200 rounded-md shadow-lg z-10"
          >
            <button
              type="button"
        ...
        {#if !imagePreview}
          ...
          >
            ...
            <p class="mt-2 text-sm text-gray-600">
              <span class="font-medium text-primary">Tap to upload</span> or drag
              and drop
            </p>
  ...
  <div
    class="fixed bottom-0 left-0 right-0 bg-white border-t border-gray-200 p-4 sm:relative sm:border-0 sm:p-0 sm:bg-transparent"
  >
    <div class="max-w-2xl mx-auto">
      <div class="flex gap-2">
        ...
        <Button
          ...
          disabled={loading ||
            !prompt.trim() ||
            (conversation.length === 0 && !imageFile)}
          class="shrink-0"
        >
          {#if loading}
